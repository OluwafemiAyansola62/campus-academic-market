  ...
  return (
    <header className="nav">
      ...
      <style jsx>{`
        ...
        nav { display: flex; align-items: center; justify-content: center; gap: 2px; padding: 4px; border-radius: 16px; background: rgba(247,248,245,.8); border: 1px solid rgba(228,232,223,.78); flex-shrink: 1; white-space: nowrap; }
        nav a { display: inline-flex; align-items: center; justify-content: center; padding: 10px 13px; border-radius: 11px; color: #56635f; font-size: 12px; font-weight: 700; white-space: nowrap; transition: color .2s ease,background .2s ease,transform .2s ease; }
        ...
        @media (max-width: 760px) {
          ...
          nav a { padding: 13px 14px; border-radius: 12px; justify-content: flex-start; }
